...
for (line = 0 ; line != bible.length ; line++)
{
	...
	if (backverset != verset)
		...
		if (verset != 1)
			...
			`<a href="../interlineaire/hellene/`+livre+`-`+chapitre+`.html#V`+verset+`">EL</a> `+ 
			`<a href="../interlineaire/romain/`+livre+`-`+chapitre+`.html#V`+verset+`">RO</a> `+ 
			`<a href="../interlineaire/francais/`+livre+`-`+chapitre+`.html#V`+verset+`">FR</a> `+
			`<a href="../interlineaire/technique/`+livre+`-`+chapitre+`.html#V`+verset+`">TE</a> \n`+
