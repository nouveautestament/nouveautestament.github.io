...
for (line = 0 ; line != sebastien_te.length ; line++)
{
	...
	if (sebastien_te[line] != "")
	{
		...
		ndfh += sebastien_te[line]+'||-F-||'+sebastien_fr[line]+"\n"
...
intro2 = intro;
intro2 += chbook[livre]+'<br><br>----VERSET----';
...
xxxxx +=`
<br><br><br>
<div id="V`+verset+`"></div><a href="#a"><b>`+xbook[livre]+' '+chapitre+' '+verset+`</b></a> 
<a  href="../hellene/`+livre+`-`+chapitre+`.html#V`+verset+`">EL</a> 
<a href="../francais/`+livre+`-`+chapitre+`.html#V`+verset+`">FR</a> 
<a href="../technique/`+livre+`-`+chapitre+`.html#V`+verset+`">TE</a>
<table cellspacing="0"><tbody>
...
//add tr 2
xxxxx += `
<tr><td class="td1">SBL-TAUBER</td><td class="td2">2018</td><td class="td3">`+james+`</td></tr>
`;
...
if ( lineseb == sebastien_te.length-1 && linejames == tauber_te.length-1 && lignerobin == robinson_te.length-1 && linejerome == ieronymus_ro.length-1)
{
	...
	xxxxx = xxxxx.replace("----VERSET----",intro_ver+"<br><br>");
	fichier2.writeFileSync(backlivre+'-'+backchap+'.html',xxxxx+'</tbody></table></div><br></body></html>', 'utf8');
